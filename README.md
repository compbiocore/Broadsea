...
recreates Atlas support data, clears WebAPI's persisted WintEHR report cache,
rebuilds ARES, and restarts WebAPI. It finishes successfully only when Atlas's
own Person and Condition Era report endpoints contain mapped race, mapped
ethnicity, and condition-era results. Refresh the Atlas browser page when it
finishes.
